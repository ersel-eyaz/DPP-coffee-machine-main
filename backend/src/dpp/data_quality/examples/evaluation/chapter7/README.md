...
| S1 | Service | `service_harmonization.json` | Field-label and service-text harmonization, including review behaviour | harmonize | Two normalized texts, one unresolved text retained, and one review finding in `both` mode | verified |
