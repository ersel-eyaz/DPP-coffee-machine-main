...
EMISSION_SCOPE = ScopeDefinition(
    ...
    relations=(
        CanonicalRelation(
            ...
            required=True,
            description="Preserves the embedded activity input used in the emission calculation.",
        ),
        CanonicalRelation(
            source_entity_type="GHGEmissionRecord",
            ...
            representation="embedded",
            required=True,
            description="Preserves the embedded emission factor used in the emission calculation.",
        ),
    ),
)
